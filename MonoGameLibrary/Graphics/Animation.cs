...
{
    /// <summary>
    /// The texture regions that make up the frames of this animation. The order of the regions within
    /// the collection are the order that the frames should be displayed in.
    /// </summary>

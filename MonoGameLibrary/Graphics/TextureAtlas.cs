    ...
    public static TextureAtlas FromFile(ContentManager content, string fileName)
    {
        ...
        using (Stream stream = TitleContainer.OpenStream(filePath))
        {
            using (XmlReader reader = XmlReader.Create(stream))
            {
                ...
                // Example:
                // <Regions>
                //      <Region name="spriteOne" x="0" width="32" height="32" />
                ...
                // The <Animations> element contains individual <Animation> elements, each one 
                // describing a different animation within the atlas.
                //
                // Example:
                // <Animations>
